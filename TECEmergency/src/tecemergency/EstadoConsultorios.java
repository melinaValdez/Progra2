...
public class EstadoConsultorios extends javax.swing.JFrame {
    LinkedList consVerdes = LinkedList.getConsultoriosVerdes();
    LinkedList consAmarillos = LinkedList.getConsultoriosAmarillos();
    LinkedList consRojos = LinkedList.getConsultoriosRojos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstadoConsultorios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
